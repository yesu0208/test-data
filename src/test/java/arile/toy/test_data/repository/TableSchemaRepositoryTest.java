...
class TableSchemaRepositoryTest {
    ...
    @Autowired
    private TableSchemaRepository sut; // 하나로 정해졌으니, 그냥 sut 이름으로 가져간다.
    ...
    @DisplayName("사용자별 테스트 스키마 이름을 조회하면, 테이블 스키마를 반환한다.")
    @Test
    ...
    @Test
    void givenUserUdAndSchemaName_whenDeletingTableSchema_thenDeletes() {
        // Given
        var userId = "djkeh";
        var schemaName = "test_schema1";
